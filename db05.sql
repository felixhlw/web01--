...
CREATE TABLE `ad` (
  ...
  `text` text COLLATE utf8mb4_unicode_520_ci DEFAULT '\'\'',
...
CREATE TABLE `admin` (
  ...
  `pw` varchar(64) COLLATE utf8mb4_unicode_520_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
(3, '12313', '我是次選單123456', 1, 1),
(5, 'index.php?do=login', '123', 1, 0),
(9, 'fdhgfdgfhdhgf', '次二', 1, 1),
(10, 'index.php?do=news', '哈哈哈', 1, 2),
(11, '2312321', 'fdgdfgfd', 1, 5);
...
(3, '01B01.jpg', 'gggggggggggggg', 0),
(5, '01B02.jpg', '999999', 0),
(6, '01B03.jpg', '11111111111111', 1),
(7, '01B04.jpg', '333333333333333', 0);
